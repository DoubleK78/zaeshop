...
namespace Portal.Infrastructure.Migrations
{
    ...
    [Migration("20240323111931_AlbumTopTypeColumns")]
    partial class AlbumTopTypeColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Domain.AggregatesModel.AlbumAggregate.Album", b =>
                {
                    ...
                    b.Property<decimal>("ViewsByTopDay")
                        .HasColumnType("decimal(20,0)");

                    b.Property<decimal>("ViewsByTopMonth")
                        .HasColumnType("decimal(20,0)");

                    b.Property<decimal>("ViewsByTopWeek")
                        .HasColumnType("decimal(20,0)");

                    b.Property<decimal>("ViewsByTopYear")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("Portal.Domain.AggregatesModel.CollectionAggregate.CollectionView", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("CollectionId"), new[] { "Date", "View" });
            ...
            modelBuilder.Entity("Portal.Domain.AggregatesModel.CollectionAggregate.ReplyComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Domain.AggregatesModel.UserAggregate.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portal.Domain.AggregatesModel.CollectionAggregate.ReplyComment", b =>
                {
                    b.HasOne("Portal.Domain.AggregatesModel.CollectionAggregate.Comment", "Comment")
